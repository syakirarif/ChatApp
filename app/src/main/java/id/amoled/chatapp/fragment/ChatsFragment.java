...
import id.amoled.chatapp.model.Chat;
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<Chat> options =
                new FirebaseRecyclerOptions.Builder<Chat>()
                        .setQuery(mMessageDatabase, Chat.class)
                        .build();
        ...
        FirebaseRecyclerAdapter<Chat, ChatsViewHolder> adapter = new FirebaseRecyclerAdapter<Chat, ChatsViewHolder>(options) {
            ...
            @Override
            protected void onBindViewHolder(@NonNull final ChatsViewHolder holder, int position, @NonNull final Chat chat) {

                final String list_user_id = getRef(position).getKey();
                Log.d(TAG, "onCreateViewHolder (list_user_id) : " + list_user_id);
                ...
                lastMessageQuery.addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        ...
                        holder.setMessage(data, chat.isSeen());
